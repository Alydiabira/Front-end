...
var has3d,
  ...
  flipOptions = {
   ...
   // Coins
     // vers l'arrière : active les coins tl et bl
     // vers l'avant : active les coins tr et br
     // all : active tous les coins
...
turnMethods = {
 ...
 // Constructeur singleton
  ...
  init: function(opts) {
    ...
    // Ajouter des pages depuis le DOM
  ...
  addPage: function(element, page) {
    ...
    // Lire le numéro de page du nom de classe de `element` - format : p[0-9]+
    ...
    if (page>=1 && page<=lastPage) {
      ...
      // Déplacez les pages si nécessaire
      ...
      // Supprimer les pages hors plage
    ...
    if (element)
      if (turnMethods._necessPage.call(this, page)) {
        ...
        if (!data.pageWrap[page]) {
          ...
          // Déplacer l'élément vers le wrapper
          data.pageWrap[page].prepend(data.pageObjs[page]);

        }

        // Si la page est dans la vue actuelle, créez l'effet de retournement
...
// Déplacer les pages derrière `page`    
    turnMethods._movePages.call(this, page, -1);
...
// Détecte si les pages sont animées
  animating: function() {
...
// Mettre à jour le mouvement
      ...
      for (page in data.pageWrap) {
        ...
        if ((p = data.pages[page])) {
          ...
          if (data.tpage)
            p.flip('disable', true); // données.disabled || page!=une page
        }
      }
